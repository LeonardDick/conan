...
def trajectory_analysis(id_frame, CNT_centers, box_size, tuberadii, min_z_pore, max_z_pore, length_pore, Walls_positions) -> None:
    ...
    ddict.printLog('(5) Calculate the coordination number of all species in the system')
    ddict.printLog('(6) Calculate the distance between liquid and pore atoms')
    ddict.printLog('(7) Calculate the three dimensional density distribution of the liquid in the simulation box')
    ddict.printLog('(8) Calculate the velocity of the liquid inside the CNT')
